...
def print_status(stats):
    ...
    # Show sample of orphaned entities
    ...
    avg_entity_size = 500  # bytes per entity (rough estimate)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 cleanup_entities.py --check          # View status report
  python3 cleanup_entities.py --cleanup        # Remove orphaned entities
  python3 cleanup_entities.py --nuclear        # Remove ALL entities (fresh start)
  python3 cleanup_entities.py --dry-run        # Preview cleanup without making changes
