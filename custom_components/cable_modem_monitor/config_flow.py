...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_entity_naming(self, user_input=None):
        ...
        if user_input is not None:
            # Merge connection data with entity naming preferences
        ...
        # Get current entity naming settings
        ...
        # Add custom prefix field only if custom is selected
