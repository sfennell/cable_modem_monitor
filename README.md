...
**Note**: The integration uses a plugin architecture that makes adding new modem models easy. If your modem has a web interface showing downstream/upstream channel data, it's worth trying! See the [Contributing](#contributing) section to add support for your modem.
