...
from custom_components.cable_modem_monitor.parsers.technicolor_xb7 import TechnicolorXB7Parser


@pytest.fixture
def xb7_html():
    """Load XB7 HTML fixture."""
    fixture_path = Path(__file__).parent / "fixtures" / "technicolor_xb7_network_setup.html"
